        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="/member/profile/pass/change" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" onkeyup="cekpass()" onkeydown="cekpass()" name="password" id='password' value="{{old('password')}}" placeholder="Password Baru">
                        </div>
                        <div class="form-group">
                            <label for="">Ulangi Password Baru</label>
                            <input type="password" class="form-control" onkeyup="cekpass()" onkeydown="cekpass()" name="new_pass" id='new_pass' value="{{old('new_pass')}}" placeholder="Ulangi Password Baru">
