        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" class="btn-sm btn-info" data-toggle="modal" data-target="#addsepatu"><i class="fa fa-plus"></i> Tambah Data</button>
                    ...
                    <form class="forms-sample" method="POST" action="/admin/penjualan/{{ $penjualan->id }}/update">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="">Member</label>
                            <select class="form-control" name="id_member" id='id_member'>
                                <option value="{{ $penjualan->Member->id }}">{{ $penjualan->Member->name }}</option>
                                <option value="">-------------------</option>
                                @foreach($member as $m)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onkeydown="kembali('{{$jumlah_bayar}}')" onkeyup="kembali('{{$jumlah_bayar}}')" value="Rp {{ number_format($penjualan->pembeli_bayar, 0, ',', '.') }}" name="pembeli_bayar" id='pembeli_bayar'>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="kembalian" value="{{ $penjualan->kembalian }}" id="kembalian2">
                            <input type="hidden" name="total" value="{{$total}}">
                            <input type="hidden" name="pembeli_bayar" id="pembeli_bayar_dua" value="{{ $penjualan->pembeli_bayar }}">
                        ...
                        <a onclick="cancel('/admin/penjualan/{{ $penjualan->id }}/cancel')" class="btn btn-secondary">Cancel</a>
                ...
                <form action="/admin/tempdetail/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="selected-option" style="display: none">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="back" value="/penjualan/{{$penjualan->id}}/edit">
                        </div>
                    </div>
            </div>
            <div class="selected-option" style="display: none">
